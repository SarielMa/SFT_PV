...
DATA_DIR="/home/lm2445/project_pi_sjf37/lm2445/PV_multiagent/sft/baseline_promt_data/train/"
FINBEN_TASKS_PATH="/home/lm2445/project_pi_sjf37/lm2445/finben/FinBen/tasks/pv_miner_base"
...
for MODEL in "${MODELS[@]}"; do
  ...
  lm_eval --model vllm \
    ...
    --tasks PvExtraction_base \
    --num_fewshot 0 \
    --batch_size auto \
    --output_path "${EVAL_DIR}/PvExtraction_base" \
    --log_samples \
    --apply_chat_template \
