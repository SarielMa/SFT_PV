...
class Config:
    ...
    enable_token_weighting: bool = False
    token_weight_code: float = 2
    token_weight_subcode: float = 3
    token_weight_span: float = 4
    weight_diff_tokens: float = 2
    normalize_by_weight_mass: bool = False # keeps avg token weight ~1.0 (your current behavior)

    # Length normalization (toggleable; default preserves current behavior)
    enable_length_norm: bool = False
    length_norm_by: str = "weight_mass"   # "tokens" | "weight_mass"

    # Class balancing (example reweighting; default OFF)
    enable_class_balance: bool = False
    ...
    class_balance_combine: str = "max"             # max|geom|mean
    class_balance_max_weight: float = 3.0
    class_balance_use_code: bool = False
    class_balance_use_subcode: bool = False
