...
lm_eval --model vllm \
  --model_args "pretrained=/home/lm2445/project_pi_sjf37/lm2445/PV_multiagent/sft/runs/pv_sft_Qwen2.5-1.5B-Instruct_merged_epoch3,tensor_parallel_size=1,gpu_memory_utilization=0.90,max_model_len=8096" \
  --tasks PvExtraction_full \
  --num_fewshot 0 \
  --batch_size auto \
  --output_path results/PV_qlora_qwen1p5b_merged_epoch3 \
  --log_samples \
  --apply_chat_template \
  --include_path /home/lm2445/project_pi_sjf37/lm2445/finben/FinBen/tasks/pv_miner
